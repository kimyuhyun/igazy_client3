        ...
        <Layout>
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-4">
                    <label className="w-32 font-semibold text-gray-700 dark:text-gray-200">영점잡기</label>
                    <RippleButton className="bg-green-600 text-white px-4 py-2" onClick={() => handleCalibrate()}>
                        영점잡기
                    </RippleButton>
                </div>
